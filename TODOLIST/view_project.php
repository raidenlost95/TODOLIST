...
$stat = array("Pendiente","Iniciado","En curso","En pausa","Atrasado","Completado");
...
<div class="col-lg-12">
								...
								<tr>
			                        ...
			                        <td class="text-center">
					                    ...
					                    <div class="dropdown-menu" style="">
					                      ...
					                      <div class="dropdown-divider"></div>
					                      <a class="dropdown-item delete_task" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Borrar</a>
					                  <?php endif; ?>
					                    </div>
									</td>
		                    	</tr>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Avance/Actividad de los Integrantes</b>
					<div class="card-tools">
						...
						<div class="post">
		                      ...
		                      <div class="user-block">
								  ...
								  <div class="dropdown-menu">
			                      	...
			                      	<div class="dropdown-divider"></div>
				                     <a class="dropdown-item delete_progress" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Borrar</a>
								  </div>
								</span>
								<?php endif; ?>
		                        ...
		                        <span class="description">
		                        	...
		                        	<span> | </span>
                      				<span>Final: <b><?php echo date('h:i A',strtotime($row['date'].' '.$row['end_time'])) ?></b></span>
	                        	</span>
...
<script>
	...
	_conf("Seguro que quieres borrar este avance?","delete_progress",[$(this).attr('data-id')])
	})
