...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm">
						...
						<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>En pausa</option>
						<option value="5" <?php echo isset($status) && $status == 5 ? 'selected' : '' ?>>Completado</option>
					</select>
				</div>
			</div>
		</div>
      ...
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Integrantes del Equipo de Proyecto</label>
