			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<thead>
					<tr>
						...
						<th>Fecha de Vencimiento del Proyecto</th>
...
<script>
	...
	$('.new_productivity').click(function(){
		uni_modal("<i class='fa fa-plus'></i> Nuevo Avance para: "+$(this).attr('data-task'),"manage_progress.php?pid="+$(this).attr('data-pid')+"&tid="+$(this).attr('data-tid'),'large')
	})
	})
